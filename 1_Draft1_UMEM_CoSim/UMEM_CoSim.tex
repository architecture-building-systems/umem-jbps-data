...
\colrule
 ...
 \hline
 Long Wave Radiation & Environmental Radiant Temp. & The calculated $T_{env}$ from the sky, ground, and surrounding surfaces \\
 \hline
...
Wall, Roof & Outside Surface Temperature & The temperature on the outside of the surface in $^{\circ}\mathrm{C}$ \\    
    \hline
Wall & Average Outside Surface Temperature & The (weighted) average temperature of the surface on the outside in $^{\circ}\mathrm{C}$. \\
    \hline
